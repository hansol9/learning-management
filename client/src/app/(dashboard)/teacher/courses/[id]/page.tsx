...
import DroppableComponent from "@/app/(dashboard)/teacher/courses/[id]/DroppableComponent";
import ChapterModal from "@/app/(dashboard)/teacher/courses/[id]/ChapterModal";
import SectionModal from "@/app/(dashboard)/teacher/courses/[id]/SectionModal";
...
const CourseEditor = () => {
  ...
  const onSubmit = async (data: CourseFormData) => {
    try {
      const updatedCourse = await uploadAllVideos(
        sections,
        id,
        getUploadVideoUrl
      );

      const formData = createCourseFormData(data, updatedCourse);
